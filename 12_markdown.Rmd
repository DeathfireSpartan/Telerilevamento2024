...
We are using the set from Mato Grosso, and we can plot it in a RGB space, as:

```{r, eval=T}
im.plotRGB(mato, 2, 1, 3)
```

In order to look at the different band combinations altogether we can use: 
